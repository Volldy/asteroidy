...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 26 13:26:11 2018
...
obrazek.anchor_x = obrazek.width // 2       #nefunguje
obrazek.anchor_y = obrazek.height // 2       #nefunguje
...
pyglet.app.run()        #vždycky na konci
print('Hotovo!')